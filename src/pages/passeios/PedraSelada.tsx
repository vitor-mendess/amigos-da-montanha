...
const imagens = [
  ...
  "/imgs/pedra-selada/06.jpg",
  "/imgs/pedra-selada/07.jpeg",
  "/imgs/pedra-selada/08.JPG",
  "/imgs/pedra-selada/09.JPG",
  "/imgs/pedra-selada/10.jpg",
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                [
                  "Alimentação",
                  "Sanduíches, chocolates, barras, frutas e refeição adequada para trilha.",
                ],
                [
                  "Hidratação",
