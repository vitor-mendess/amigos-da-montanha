...
const imagens = [
  ...
  "/imgs/couto_prateleiras/20.jpg",
  "/imgs/couto_prateleiras/21.jpg",
  "/imgs/couto_prateleiras/22.jpg",
  "/imgs/couto_prateleiras/23.jpg",
  "/imgs/couto_prateleiras/24.jpg",
  "/imgs/couto_prateleiras/25.jpg",
  "/imgs/couto_prateleiras/26.jpg",
      ...
      <FaArrowRight />
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                ["Alimentação", "Sanduíches, chocolates, barras de cereais e frutas."],
                ["Hidratação", "Mínimo de 1,5L de água por pessoa."],
                ["Vestimenta", "Roupas em camadas, bota ou tênis de trilha."],
                ["Acessórios", "Protetor solar, capa de chuva e lanterna."],
              ].map(([titulo, texto], i) => (
