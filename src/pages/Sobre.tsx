        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6 text-[#1C1C1C]">
            ...
            <p className="text-lg font-semibold">
              Mais de 30 anos de experiências na Mantiqueira
            </p>
            ...
            <p className="border-l-4 border-[#1C1C1C] pl-4 text-lg">
              Acreditamos que atravessar paisagens de tirar o fôlego e pisar em um cume de montanha, é mais do que um passeio, é um momento inesquecível para
              se levar.
            </p>
